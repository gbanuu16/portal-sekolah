        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="form-group text-center">
                    <img class="img-thumbnail logoweb" onclick="logo('<?= $konfigurasi_id ?>')" src="<?= base_url('img/konfigurasi/logo/' . $logo) ?>" width="200px" alt="Foto">
                </div>
            </div>
        </div>
        <div class="card mb-4">
            <div class="card-body">
                ...
                <hr>
                <div class="form-group text-center">
                    <img class="img-thumbnail" onclick="icon('<?= $konfigurasi_id ?>')" src="<?= base_url('img/konfigurasi/icon/'  . $icon) ?>" width="60%" alt="Foto">
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function logo(konfigurasi_id) {
        $.ajax({
            type: "post",
            url: "<?= base_url('konfigurasi/formuploadlogo') ?>",
            data: {
    ...
    function icon(konfigurasi_id) {
        $.ajax({
            type: "post",
            url: "<?= base_url('konfigurasi/formuploadicon') ?>",
            data: {
                konfigurasi_id: konfigurasi_id
            },
            dataType: "json",
