...
<div class="modal fade" id="modalupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <br>
            <center>
                <img class="img-thumbnail" width="70%" src="<?= base_url('img/konfigurasi/logo/'  . $list['logo']) ?>" alt="Logo Website">
            </center>
            <input type="hidden" value="<?= $konfigurasi_id ?>" name="konfigurasi_id">
            <div class="modal-body">
                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label">Upload</label>
                    <div class="col-sm-10">
                        <input type="file" class="form-control" id="logo" name="logo">
                        <div class="invalid-feedback errorLogo">
...
<script>
    $(document).ready(function() {
        $('.btnupload').click(function(e) {
            e.preventDefault();
            let logoweb = '<?= base_url('img/konfigurasi/logo/' . $list['logo']) ?>';
